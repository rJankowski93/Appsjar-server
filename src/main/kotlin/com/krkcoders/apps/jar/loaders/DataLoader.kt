...
class DataLoader @Autowired constructor(private val appRepository: AppRepository,
    ...
    private fun saveSampleAppsToDb() {
        ...
        appRepository.save(listOf(
                ...
                App(ObjectId.get().toString(), "TicTacToe", "2.5.3", "v=cNfK6LNuGa4", SampleDate.descriptions.description1, 3.0, SampleDate.icons.twitterIcon),
    ...
    private fun saveSampleUsersToDb() {
        ...
        userRepository.save(listOf(
                User(ObjectId.get().toString(), "admin", "admin", listOf(appRepository.findByName("Facebook"), appRepository.findByName("Asphalt"), appRepository.findByName("BallGame"))),
